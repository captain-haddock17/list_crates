...
--  Ada 2005: Implementation of AdaForge.Wide_Wide_Directories (AI95-00248). Note that this
...
package AdaForge.Wide_Wide_Directories is

   -----------------------------------
   -- Directory and File Operations --
   -----------------------------------

   function Current_Directory return Wide_Wide_String;
   ...
   procedure Set_Directory (Directory : Wide_Wide_String);
   ...
   procedure Delete_Directory (Directory : Wide_Wide_String);
   ...
   procedure Delete_Tree (Directory : Wide_Wide_String);
   ...
   procedure Delete_File (Name : Wide_Wide_String);
   ...
   procedure Rename (Old_Name, New_Name : Wide_Wide_String);
   ...
   function Full_Name (Name : Wide_Wide_String) return Wide_Wide_String;
   ...
   function Simple_Name (Name : Wide_Wide_String) return Wide_Wide_String;
   ...
   function Containing_Directory (Name : Wide_Wide_String) return Wide_Wide_String;
   ...
   function Extension (Name : Wide_Wide_String) return Wide_Wide_String;
   ...
   function Base_Name (Name : Wide_Wide_String) return Wide_Wide_String;
   ...
   function Name_Case_Equivalence (Name : Wide_Wide_String) return Name_Case_Kind;
   ...
   function Kind (Name : Wide_Wide_String) return File_Kind;
   ...
   function Size (Name : Wide_Wide_String) return File_Size;
   ...
   function Modification_Time (Name : Wide_Wide_String) return Ada.Calendar.Time;
   ...
   function Simple_Name (Directory_Entry : Directory_Entry_Type) return Wide_Wide_String;
   ...
   function Full_Name (Directory_Entry : Directory_Entry_Type) return Wide_Wide_String;

...
package body AdaForge.Wide_Wide_Directories.Validity is
   ...
   function Is_Valid_Path_Name (Name : Wide_Wide_String) return Boolean is
   begin
      ...
      if Name'Length = 0 then
         ...
         for J in Name'Range loop
            if Name (J) = To_Wide_Wide_Character (Latin_1.NUL) then
               return False;
            end if;
         end loop;
      end if;
   ...
   function Is_Valid_Simple_Name (Name : Wide_Wide_String) return Boolean is
   begin
      ...
      if Name'Length = 0 then
         ...
         for J in Name'Range loop
            if Name (J) = '/' or else Is_Control (Name (J)) then
               return False;
            end if;
         end loop;
      end if;
...
end AdaForge.Wide_Wide_Directories.Validity;

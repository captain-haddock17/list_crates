...
private package AdaForge.Wide_Wide_Directories.Validity is

   function Is_Valid_Simple_Name (Name : Wide_Wide_String) return Boolean;
   --  Returns True if Name is a valid file name

   function Is_Valid_Path_Name (Name : Wide_Wide_String) return Boolean;

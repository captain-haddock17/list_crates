...
package body AdaForge.Wide_Wide_Directories.Hierarchical_File_Names is
   ...
   function Is_Absolute_Path (Name : Wide_Wide_String) return Boolean;
   ...
   begin
      ...
      declare
         Normal_Left  : constant Wide_Wide_String :=
         ...
         Normal_Right : constant Wide_Wide_String :=
   ...
   function Is_Absolute_Path (Name : Wide_Wide_String) return Boolean is
   ...
   function Is_Simple_Name (Name : Wide_Wide_String) return Boolean is
   begin
   ...
   function Is_Root_Directory_Name (Name : Wide_Wide_String) return Boolean is
   begin
   ...
   function Is_Parent_Directory_Name (Name : Wide_Wide_String) return Boolean is
   begin
      return Name = "..";
   ...
   function Is_Current_Directory_Name (Name : Wide_Wide_String) return Boolean is
   begin
      return Name = ".";
   ...
   function Is_Full_Name (Name : Wide_Wide_String) return Boolean is
   begin
   ...
   function Is_Relative_Name (Name : Wide_Wide_String) return Boolean is
   begin
   ...
   function Initial_Directory (Name : Wide_Wide_String) return Wide_Wide_String is
   ...
   function Relative_Name (Name : Wide_Wide_String) return Wide_Wide_String is
   begin
      ...
      then
         raise Name_Error with "invalid relative path name """ & Encode (Name, UTF_8) & '"';
      end if;
      ...
      then
         raise Name_Error with
           "relative path name """ & Encode (Name, UTF_8) & """ is composed of a single part";
      end if;
      ...
      declare
         Init_Dir : constant Wide_Wide_String := Initial_Directory (Name);
      begin
   ...
   begin
      ...
      if not Is_Relative_Name (Relative_Name) then
         raise Name_Error with
           "invalid relative path name """ & Encode (Relative_Name, UTF_8) & '"';
      end if;
      ...
      then
         raise Name_Error with
           "invalid path composition """ & Encode (Separated_Dir & Relative_Name, UTF_8) & '"';
      end if;
      ...
      then
         raise Name_Error with
           "invalid path composition """
             & Encode (Separated_Dir & Relative_Name & Extension, UTF_8) & '"';
      end if;
...
end AdaForge.Wide_Wide_Directories.Hierarchical_File_Names;

...
--                                                                          --
--                  AdaForge.Wide_Wide_Directories.HIERARCHICAL_FILE_NAMES                 --
--                                                                          --
--                                 S p e c                                  --
--                                                                          --
...
package AdaForge.Wide_Wide_Directories.Hierarchical_File_Names is

   function Is_Simple_Name (Name : Wide_Wide_String) return Boolean;
   --  Returns True if Name is a simple name, and returns False otherwise.

   function Is_Root_Directory_Name (Name : Wide_Wide_String) return Boolean;
   --  Returns True if Name is syntactically a root (a directory that cannot
   --  be decomposed further), and returns False otherwise.

   function Is_Parent_Directory_Name (Name : Wide_Wide_String) return Boolean;
   ...
   function Is_Current_Directory_Name (Name : Wide_Wide_String) return Boolean;
   ...
   function Is_Full_Name (Name : Wide_Wide_String) return Boolean;
   --  Returns True if the leftmost directory part of Name is a root, and
   --  returns False otherwise.

   function Is_Relative_Name (Name : Wide_Wide_String) return Boolean;
   ...
   function Simple_Name (Name : Wide_Wide_String) return Wide_Wide_String
     renames AdaForge.Wide_Wide_Directories.Simple_Name;
   ...
   function Containing_Directory (Name : Wide_Wide_String) return Wide_Wide_String
     renames AdaForge.Wide_Wide_Directories.Containing_Directory;
   ...
   function Initial_Directory (Name : Wide_Wide_String) return Wide_Wide_String;
   ...
   function Relative_Name (Name : Wide_Wide_String) return Wide_Wide_String;
